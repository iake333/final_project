...
def index(request):
    if request.method == "POST":
        ...
        api_key = "41b14c9dfea08b671a31caab8a6d539c"
        ...
        try:
            if data['cod'] == '404':
                ...
                context = {'status': 'success', 'city': city_name, 'country': country, 'date_time': date_time,
                           'temp': temp, 'temp_F': temp_F, 'description': description, 'humidity': humidity,
                           'feels_like': feels_like, 'wind': wind, 'visibility': visibility}
